...
execute if score @s coah.d.y1 matches 200 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 300 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 300 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 400 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 400 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 500 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 500 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 600 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 600 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 700 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 700 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
execute if score @s coah.d.y1 matches 800 if score @s coah.a.c.jump1 matches 0 run tag @s add coah.step
execute if score @s coah.d.y1 matches 800 if score @s coah.a.c.jump1 matches 0 run function com_anti_hack:admin/notify_step
